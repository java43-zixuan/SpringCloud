...
import static com.example.common.constant.UnitConstants.RESPONSE_SUCCESS_CODE;
import static com.example.common.constant.UnitConstants.SUCCESS_CODE;
...
//            boolean result = !RESPONSE_SUCCESS_CODE.equals(resp.getResponseCode()) || !SUCCESS_CODE.equals(openResponse.getCode());
            ...
            if (!result) {
                // 通过
                ContextHandler.setAuthKeyVo(new Object());
            }
            return result;
        } catch (Exception e) {
