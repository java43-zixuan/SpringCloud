...
public class GatewayLogUtil {
    ...
    private final static String X_WWW_FROM_URLENCODED = "x-www-form-urlencoded";

    private final static String ATOM_XML = "atom+xml";

    private final static String RSS_XML = "rss+xml";
    ...
    private static boolean shouldRecordBody(MediaType contentType) {
        ...
        if (Constants.APPLICATION.equals(type)) {
